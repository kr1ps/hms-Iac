...
resource "vsphere_virtual_machine" "vm" {
  ...
  #  command = "ANSIBLE_HOST_KEY_CHECKING=False ANSIBLE_TIMEOUT=60 ansible-playbook -u '${var.ssh_user}' -i '${vsphere_virtual_machine.vm.default_ip_address},' ./ansible-hms/hms.yml -e 'tf_env=${terraform.workspace}' --key-file '~/.ssh/id_ed25519' --verbose"
  # }
}
